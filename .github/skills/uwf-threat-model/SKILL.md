...
description: "Generate a pragmatic threat model + mitigations for tmp/workflow-artifacts/security-plan.md."
---
# UWF Threat Model Skill

## Output
Update tmp/workflow-artifacts/security-plan.md with:
- Assets
