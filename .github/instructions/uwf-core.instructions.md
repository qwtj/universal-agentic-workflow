...
Keep `docs/workflow/*.md` as example templates; write active workflow artifacts under `tmp/workflow-artifacts/*.md`.
...
Must also: update `tmp/workflow-artifacts/intake.md` with any facts discovered that change scope or assumptions.
...
Must produce: reset `tmp/workflow-artifacts/discovery.md` scoped to this issue.
Must also: update `tmp/workflow-artifacts/intake.md` if discovery changes scope.

### Gate: Security Planning
Must produce: `tmp/workflow-artifacts/security-plan.md` scoped to this issue.
...
### Gate: Test Planning
Must produce: `tmp/workflow-artifacts/test-plan.md` scoped to this issue.
...
### Gate: Implementation
Only begin after both `tmp/workflow-artifacts/intake.md` and `tmp/workflow-artifacts/plan.md` exist for the current issue.
...
| Project & issue intake | `tmp/workflow-artifacts/intake.md` |
| Project & issue discovery | `tmp/workflow-artifacts/discovery.md` |
| Security plan | `tmp/workflow-artifacts/security-plan.md` |
| Test plan | `tmp/workflow-artifacts/test-plan.md` |
| Issue plan | `tmp/workflow-artifacts/plan.md` |
