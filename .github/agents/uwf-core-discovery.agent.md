...
## Required outputs
1. `tmp/workflow-artifacts/{mode}-discovery.md` containing:
...
2. Updated `tmp/workflow-artifacts/{mode}-intake.md` — amend any section where discovery changed scope or revealed new constraints. Mark amendments with `<!-- updated by discovery -->`.
