...
agent: "uwf-project_manager-orchestrator"
---
# Tasks
...
2. Proceed with `Project Workflow` for the active issue.
3. Complete when all planning documentation has been completed in a automated and organized manner, and the project is ready for execution.